...
import '../../staff_leader_bord/staff_leader_bord_screen.dart';
              ...
              children: [
                      ...
                      APIService.UserRegressionReport().then((response) {
                        ...
                        if (response.result != null) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => StaffReportRgressionScreen(
                                  dates: resultData,
                          ...
                          setState(() {
                            ...
                            Fluttertoast.showToast(msg: "please calculate prediction first",
                ...
                GestureDetector(
                  onTap: (){
                    ...
                    Navigator.pushNamed(context, StaffLeaderBoard.routeName);
                  },
                  child: Container(
                    height: MediaQuery.of(context).size.height * 0.11,
                    decoration: BoxDecoration(
