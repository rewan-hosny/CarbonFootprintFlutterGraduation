...
class StaffQuestionFour extends StatefulWidget {
  static String routeName = "/StaffQuestionFour";
  final Map<dynamic,dynamic> answersData ;
   StaffQuestionFour(this.answersData) ;

  @override
  State<StaffQuestionFour> createState() => _StaffQuestionFourState();
}

class _StaffQuestionFourState extends State<StaffQuestionFour> {
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                  "How much paper did the university use?",
                                  textAlign: TextAlign.center,// hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                            ...
                            Listener(
                              ...
                              child: Container(
                                ...
                                child: RadioListTile(
                                    ...
                                    title: Text("0-5 Ton",           // hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                                      style: TextStyle(
                                    ...
                                    value: "0-5 Ton",              // hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                                    groupValue: answer,
                                    onChanged: (value) {
                                      setState(() {
                            ...
                            Listener(
                              ...
                              child: Container(
                                ...
                                child: RadioListTile(
                                    activeColor: Colors.white,
                                    title: Text(
                                      "5-10 Tons",             // hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                                      style: TextStyle(
                                        fontSize: getProportionateScreenWidth(16),
                                        fontFamily: "Poppins",
                                        color: isTouching2 == true
                                    ...
                                    value: "5-10 Tons",        // hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                                    groupValue: answer,
                                    onChanged: (value) {
                                      setState(() {
                                        answer = value.toString();
                            ...
                            Listener(
                              ...
                              child: Container(
                                ...
                                child: RadioListTile(
                                    ...
                                    title: Text(
                                      "10-15 Tons",              // hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                                      style: TextStyle(
                                        fontSize: getProportionateScreenWidth(16),
                                        fontFamily: "Poppins",
                                        color: isTouching3 == true
                                    ...
                                    activeColor: Colors.white,
                                    value: "10-15 Tons",          // hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                                    groupValue: answer,
                                    onChanged: (value) {
                                      setState(() {
                                        answer = value.toString();
                            ...
                            Listener(
                              ...
                              child: Container(
                                ...
                                child: RadioListTile(
                                    title: Text(
                                      "15+ Tons",                     // hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                                      style: TextStyle(
                                        fontSize: getProportionateScreenWidth(16),
                                        fontFamily: "Poppins",
                                        color: isTouching4 == true
                                    ...
                                    activeColor: Colors.white,
                                    value: "15+ Tons",                // hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                                    groupValue: answer,
                                    onChanged: (value) {
                                      setState(() {
                                        answer = value.toString();
                      ...
                      children: [
                        ...
                        ElevatedButton(
                            onPressed: (){
                              ...
                              if(answer == "0-5 Ton"){
                                widget.answersData["Waste"]="a";
                              }
                              else if(answer =="5-10 Tons"){
                                widget.answersData["Waste"]="b";
                              }
                              else if(answer == "10-15 Tons"){
                                widget.answersData["Waste"]="c";
                              }else if(answer == "15+ Tons"){
                                widget.answersData["Waste"]="d";
                              }
                              ...
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => StaffQuestionFive(widget.answersData)));
