          ...
          child: Column(
            children: [
              ...
              Align(
                ...
                child: Text("  Reduce carbon will be : ",style: TextStyle(
                    fontSize: 22 ,color: LightModeSmallTextColor),),
              ),

              SizedBox(height: SizeConfig.screenHeight*0.02,),
              Text("${widget.data["reducedFootprint"]} kg",style: TextStyle(
                  fontSize: 25 ,color: LightModeMainColor),),
